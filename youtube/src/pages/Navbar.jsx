...
const Navbar = ({ theme, update, onDataFromChild }) => {
  ...
  useEffect(() => {
    onDataFromChild(filteredResult, searchName);
  }, [filteredResult, searchName, onDataFromChild]);
  ...
  return (
    <nav className="navbar navbar-expand-lg position-sticky w-100">
            ...
            <Link to="/" className="nav-link">
              ...
              >
                <g
                  viewBox="0 0 97 20"
                  preserveAspectRatio="xMidYMid meet"
                  className={theme ? "dark-fill" : "light-fill"}
                >
          ...
          <div className="col-lg-2 d-flex justify-content-around">
            <div className="form-check form-switch">
              <input
                ...
                onClick={() => {
                  update(!theme);
                  // console.log("Inside Function", theme);
                  setContextTheme(!contextTheme);
                }}
              />
            </div>
            <div>
              <i className="c-p fa-solid fa-video"></i>
            </div>
            <div>
              <i className="c-p fa-solid fa-bell"></i>
            </div>
            <div>
              <Link to="/signout" className="text-decoration-none text-dark">
                <i className="c-p fa-solid fa-user"></i>
              </Link>
            </div>
          </div>
        </div>
