...
const Login = ({ update }) => {
  ...
  const handleLogin = (e) => {
    ...
    const user = userData.find(
      (items, index) =>
        items.userName === username && items.password === password
    );
    if (user) {
      update(true);
      ...
      setPassValid("Please Enter Correct Pass");
    }
  };
  return (
    <div className="container-fluid">
      <div className="drop vh-100 d-flex justify-content-center align-items-center">
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-5">
              <div className="row bs1 gy-3 justify-content-center g-2 p-5 rounded-3">
                {/* <h2 className="text-center">Login</h2> */}
                <div className="col-lg-4 mb-3 justify-content-center">
                  <svg
                    viewBox="0 0 97 20"
                ...
                <div className="col-lg-12">
                  ...
                  <span className="d-block fw-16 text-danger">{passValid}</span>
                </div>
